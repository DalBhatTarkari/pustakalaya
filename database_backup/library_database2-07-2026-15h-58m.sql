...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 07, 2026 at 11:12 AM
...
CREATE TABLE `bookmarks` (
  ...
  `status` enum('reading','planned','dropped','completed') NOT NULL DEFAULT 'reading'
...
INSERT INTO `bookmarks` (`bookmark_id`, `u_id`, `book_id`, `marked_on`, `status`) VALUES
(1, 1, 1, '2026-02-07 13:33:33', 'completed'),
(3, 1, 7, '2026-02-07 10:30:00', 'planned'),
(4, 1, 59, '2026-02-07 11:01:37', 'reading'),
(5, 1, 95, '2026-02-07 11:02:04', 'reading');
...
(100, 'Changed Role of UserID :1 to USER', '1_dalbhattarkari', 'user', 'Array\n(\n    [role change] => 1\n)\n', 'Array\n(\n    [id] => 1\n    [role] => user\n)\n', '2026-01-30', '10:19:06'),
(101, 'Changed Role of UserID :7 to USER', '1_dalbhattarkari', 'admin', 'Array\n(\n    [role change] => 1\n)\n', 'Array\n(\n    [id] => 7\n    [role] => user\n)\n', '2026-01-30', '10:25:51'),
(102, 'Changed Role of UserID :7 to USER', '1_dalbhattarkari', 'admin', 'Array\n(\n    [role change] => 1\n)\n', 'Array\n(\n    [id] => 7\n    [role] => user\n)\n', '2026-01-30', '10:55:12'),
(103, 'Changed Role of UserID :5 to USER', '1_dalbhattarkari', 'admin', 'Array\n(\n    [role change] => 1\n)\n', 'Array\n(\n    [id] => 5\n    [role] => user\n)\n', '2026-01-30', '11:02:12'),
(104, 'Changed Details of UserID :5', '1_dalbhattarkari', 'admin', 'Array\n(\n    [Details Changed] => 1\n)\n', 'Array\n(\n    [id] => 5\n    [email] => rambdr@gmail.com\n    [role] => user\n)\n', '2026-01-30', '11:03:50'),
(105, 'Password Reset For User with Email: uless668@gmail.com', '1_dalbhattarkari', 'admin', 'Array\n(\n    [password_reset] => 1\n)\n', 'Array\n(\n    [password_reset] => 1\n)\n', '2026-01-30', '11:30:35'),
(106, 'Password Reset For User with Email: uless668@gmail.com', '1_dalbhattarkari', 'admin', 'Array\n(\n    [password_reset] => 1\n)\n', 'Array\n(\n    [password_reset] => 1\n)\n', '2026-01-30', '11:31:23'),
(107, 'dalbhattarkari updated their passwords', '1_dalbhattarkari', 'admin', 'Array\n(\n)\n', 'Array\n(\n    [changed_pwd] => 1\n)\n', '2026-01-30', '11:31:42'),
(108, 'edit', '1_dalbhattarkari', 'admin', 'Array\n(\n    [id] => 59\n    [title] => HAMLET\n    [cover] => https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQJERmiLF5IQF_ERwTdyD7gOtWDY9fQbJ8v-g&s\n    [author] => WILLIAM SHAKESPEAR\n    [genre] => DRAMA\n    [description] => ABOUT HAMLET\n    [file_path] => hamlet.pdf\n    [status] => approved\n)\n', 'Array\n(\n    [id] => 59\n    [title] => HAMLET\n    [cover] => https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQJERmiLF5IQF_ERwTdyD7gOtWDY9fQbJ8v-g&s\n    [author] => WILLIAM SHAKESPEAR\n    [genre] => DRAMA\n    [description] => ABOUT HAMLET\n    [path] => hamlet.pdf\n    [status] => approved\n)\n', '2026-02-07', '10:42:49');
...
(66, 'TEST BOOK 1', '/pustakalaya/defaults/cover.jpg', 'AUTHOR1', 'GENRE1,GENRE2,GENRE3', 'DESCRIPTION', NULL, 'pending');
...
(1, 'dalbhattarkari', '$2y$10$w148IJmz.QnNEZX2nqNeAu4WuhpyKQHrS0Qr3ZI5B6Lc5wikDhERO', 'uless668@gmail.com', '2026-01-24', 'admin'),
...
(5, 'rambahadurthapa', '$2y$10$sHUdNaNfFrBrHa1CNipUi.clJhJF.BLFJQleg6W0jvhaRF7WEjvGS', 'rambdr@gmail.com', '2025-12-23', 'user'),
...
--
ALTER TABLE `bookmarks`
  MODIFY `bookmark_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `logs`
  MODIFY `logid` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=109;
...
--
ALTER TABLE `bookmarks`
  ADD CONSTRAINT `bookmarks_ibfk_1` FOREIGN KEY (`u_id`) REFERENCES `users` (`id`),
